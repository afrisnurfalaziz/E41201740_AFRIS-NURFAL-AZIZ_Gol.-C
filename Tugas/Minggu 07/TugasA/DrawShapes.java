...
public class DrawShapes extends Applet {
    ...
    public void init() {
        ...
        // Some colors are predelined in the Color class
        redColor = Color.red;
    ...
    public void paint(Graphics graph) {
        ...
        // Draw a rectangle using drawRect(int x, int y, int widht, int helght)
        ...
        // Draw a circle using drawArc(int x, int y, int widht, int height, int starttAngle, int arcAngle)
